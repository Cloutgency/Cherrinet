...
const allPlans: Plan[] = [
  {
    ...
    benefits: [
      ...
      "1 device simultaneous streaming",
  ...
  },
  {
    ...
    benefits: [
      ...
      "5 devices simultaneous streaming",
      "Wi-Fi 6 mesh router",
      "Priority support with dedicated manager",
      "Free static IP",
      "Gaming optimized routing",
    ],
    //ott: ["Hotstar", "ZEE5", "SonyLIV"],
  },
  {
    id: "ultra",
    name: "Ultra",
    ...
    benefits: [
      ...
      "VIP support with SLA guarantee",
      "Free static IP",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Unlimited devices",
      "Wi-Fi 6E tri-band mesh system",
      "Dedicated account manager",
      "99.99% uptime SLA",
      "Business-grade features",
    ],
    //ott: ["Hotstar", "ZEE5", "SonyLIV", "Amazon Prime", "Netflix"],
  },
];
